...
/**
 * Class SteeinUserAgent
 * SteeinUserAgent generates User Agent for curl requests
 *
 * @package Steein\SDK\Common
 */
class SteeinUserAgent
{
    /**
    ...
    public static function getValue($sdkName, $sdkVersion)
    {
        ...
        return sprintf("SteeinSDK/%s %s (%s)", $sdkName, $sdkVersion, implode('; ', $featureList));
    }
